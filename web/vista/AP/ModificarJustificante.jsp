...
<head>
    <%
        String idJustificante = (String) request.getParameter("prodId");
...
<body id="page-top" onload="consultarJustificantePendienteEspecifico(<%=idJustificante%>)" >
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div class="text-center d-none d-md-inline">
            <button class="rounded-circle border-0" id="sidebarToggle" onclick="modificarJustificante()"></button>
        </div>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <h1 class="h3 mb-4 text-gray-800">Modificar Justificante</h1>
                    </div>
                </div>
                ...
                <form class="user">
                    ...
                    <a class="btn btn-primary btn-user btn-block"  onclick="modificarJustificante()">Enviar
                    </a>
                </form>
            </div>
            <!-- /.container-fluid -->
